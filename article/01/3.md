...
[multithreading - Java: difference and use between ThreadPool and ThreadGroup? - Stack Overflow](https://stackoverflow.com/questions/31756543/java-difference-and-use-between-threadpool-and-threadgroup)

Thread group class was created in JDK 1.0 to manage the state of multiple threads at once e.g suspend, resume etc. Later most of its important methods were deprecated because of potential deadlock they can create.
